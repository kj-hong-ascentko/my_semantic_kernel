...
class CodeBlock(Block, CodeRenderer):
    ...
    def is_valid(self) -> Tuple[bool, str]:
        ...
        for token in self._tokens:
            is_valud, error_msg = token.is_valid()
            if not is_valud:
    ...
    async def _get_function_from_skill_collection(
        self, 
        skills: ReadOnlySkillCollectionBase, 
        f_block: FunctionIdBlock) -> Optional[SKFunctionBase]:        
